...
namespace djv
{
	...
	namespace shape
	{
		class DJV_API ThickRect : public Shape
		{
			public:
		...
		class DJV_API FilledRect : public ThickRect
		{
			public:
		...
		class DJV_API Rect : public ThickRect
		{
			public:
		...
		class DJV_API Crown : public Shape
		{
			public:
		...
		class DJV_API Disc : public Crown
		{
			public:
		...
		class DJV_API Circle : public Crown
		{
			public:
		...
		class DJV_API Line : public Shape
		{
			public:
